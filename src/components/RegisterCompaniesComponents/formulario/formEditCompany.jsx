                                ...
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        <Input
                                            ...
                                            onChange={inputChange}
                                        >
                                            <option key={props.company.company_country} value={props.company.company_country}>{props.company.company_country}</option>
                            ...
                            <Row form>
                                ...
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        >   
                                            <option key={props.company.industry.industry_name} value={props.company.industry.industry_id}>{props.company.industry.industry_name}</option>
